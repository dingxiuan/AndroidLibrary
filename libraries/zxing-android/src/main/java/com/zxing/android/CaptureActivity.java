...
import com.zxing.android.decode.DecodeImgCallback;
import com.zxing.android.decode.DecodeImgThread;
import com.zxing.android.decode.ImageUtil;
...
public class CaptureActivity extends AppCompatActivity implements SurfaceHolder.Callback, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*先获取配置信息*/
        try {
            config = (ZxingOptions) getIntent().getExtras().get(ZxingConstant.INTENT_ZXING_CONFIG);
        } catch (Exception e) {
